...
export var pageTitle = {view: function(vnode) {return( m("div", {class:"bg-light-gray pa2 b tracked ttu f6 black"}, vnode.children ))}}
...
export var pageFormButton = {view: function(vnode) {return(
	<div class="fl tr w-100 mt0 mv3 ph2">
		<a onclick={vnode.attrs.onclick} href="#top"
			class="link pa2 bg-black-80 near-white dim f6 br1">
			{vnode.attrs.title}
		</a>
	</div>
)}}
...
export var pageSearchForm = {view: function(vnode) {return(
	<p class="cf f6 ph2 pv2">
		...
		<span class={vnode.attrs.classNewButton}>
			<span class="pointer mv2 pa1 fl-l fr dib bg-black-80 near-white dim f6 br1" onclick={vnode.attrs.newForm}>
				+NEW
			</span>
		</span>
	</p>
	...
	<div class="fl pa2 pb4 w-100">
		<div class="overflow-auto">
			<table class="f6 w-100" cellspacing="0">
				<thead class="">
					<tr class="bg-black-80 near-white">
...
export var getPageSearchListItem = {view: function(vnode) {return(
	<tr class="">
		<td class="pa2 pr0 bb b--near-white">
